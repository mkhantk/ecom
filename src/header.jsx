    ...
    return (
        <>
            <header className="flex gap-5 justify-end items-center py-5 bg-green-600 bg-opacity-20 mb-5 px-8">
                <Link to="/">
                    <h1 className="logo mr-auto text-5xl font-bold hover:text-red-500">
                        Ecom
                    </h1>
                </Link>
                <div className="relative flex justify-center items-center m-auto">
                    <input
                        ...
                        name=""
                        id="search"
                        className="mr-auto rounded-full px-5 py-1 indent-2"
                ...
                <nav className="list-none flex gap-6">
                    ...
                    <li>
                        <Link to={"/wishlist"}>
                            ...
                            <div className="bg-red-500 px-2 rounded-full absolute top-4 right-16 text-white">
                                {wishlistCount}
                            </div>
                        </Link>
                    </li>
                    <li>
                        <Link to={"/cart"}>
                            ...
                            <div className="bg-red-500 px-2 rounded-full absolute top-4 right-4 text-white ">
                                {cartCount}
                            </div>
                        </Link>
                    </li>
