...
const Wishlist = () => {
	const { wishlist, setWishlist, setWishlistCount } =
	...
	if (isLoading) return <p>Loading favourite...</p>;
	if (isError) return <p>Please Try Again.</p>;

	//handleclick function
	function handleClick(favId: number) {
		setWishlist((prevWishlist) => prevWishlist.filter((id) => id !== favId));
