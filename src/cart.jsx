...
const Cart = () =>  {
  const { cart, setCart, allData, shopCount, setShopCount, setCartCount} = useContext(ProductContext)

  function handleClick(e) {
    setCart(prevCart => prevCart.filter(item => item !== Number(e.target.id))) 
    ...
    <>
      <div id='container' className='w-full'>
        ...
        {cart.length === 0 ? (
            ...
            <div id='cart' className='grid grid-cols-5 gap-5'>
